...
public Connection closeconnexion() {
 ...
 public ResultSet exécutionQuery(String sql) {
        ...
        try {
            statement = connection.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY, ResultSet.CONCUR_UPDATABLE);
 ...
 public ResultSet querySelectAll(String nomTable) {
  ...
  public ResultSet querySelectAll(String nomTable, String état) {
   ...
   public ResultSet querySelect(String[] nomColonne, String nomTable) {
    ...
    public String insertblob (FileInputStream file,String c) {
       return c;
    }
